...
echo "     MAIL_USERNAME=radnucleus@gmail.com"
echo "     MAIL_PASSWORD=pftmjsssraekcktm"
echo "     MAIL_DEFAULT_SENDER=radnucleus@gmail.com"
echo ""
echo "2. Render"
...
echo "   - Run: heroku config:set MAIL_USERNAME=radnucleus@gmail.com"
echo "   - Run: heroku config:set MAIL_PASSWORD=pftmjsssraekcktm"
echo "   - Run: heroku config:set MAIL_DEFAULT_SENDER=radnucleus@gmail.com"
echo ""
